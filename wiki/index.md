...
# Wiki Index
> 全ページのカタログ。Claude が ingest のたびに自動更新する。

---

## Entities（人物・組織・ツール）

- [[entities/andrej-karpathy]] — AI研究者。LLM Knowledge Base システムの提唱者（2ソース）
...
- [[concepts/llm-knowledge-base]] — RAGではなくWikiを継続構築するKarpathy提唱の知識管理方式（3ソース）
- [[concepts/rag-vs-wiki]] — RAGとLLM Wiki型の比較。なぜWikiが優れるか（1ソース）
- [[concepts/obsidian-vault-structure]] — AI第二脳のフォルダ設計と各要素の役割（2ソース）
- [[concepts/agent-browser]] — raw/自動充填CLIツール。Playwright MCP比82%トークン削減（1ソース）
